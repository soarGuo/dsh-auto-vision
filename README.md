...
A [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) plugin that bridges images into text: when the session's selected model cannot see images, a configured vision model describes them, and the descriptions enter the durable session history as **folded context rows** — your original message stays untouched.
